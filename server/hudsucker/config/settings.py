...
class Settings(object):
    ...
    registry_config = {"type":"yaml", "source":"registry/db/registry.yaml"}
    registry = None
    base_path = '~/'
    @staticmethod
    def load_xml(config='config/settings.config'):
        ...
        <ContentProxy>
            ...
            or
            <ServiceRegistry type="demisauce" appname="hudsucker_testing" 
        ...
        try:
            ...
            if _registry == None:
                ...
                Settings.registry_config = svc_node
            else:
                Settings.registry_config = _registry.attrib
